...
class Contact extends Component {
    ...
    return (
      <React.Fragment>
        <div className={styles.state} onClick={() => this.userSelect("user1",1)}>
        ...
        <div className={styles.state} onClick={() => this.userSelect("user2",2)}>
          <div className={styles.pic}>
        ...
        <div className={styles.state} onClick={() => this.userSelect("user3",4)}>
          <div className={styles.pic}>
        ...
        <div className={styles.state} onClick={() => this.userSelect("user4",7)}>
          <div className={styles.pic}>
